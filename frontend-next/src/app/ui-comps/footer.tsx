                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    <div className="space-y-6">
                        ...
                        <p className="text-sm max-w-md">
                            Empowering local food vendors with sustainable solutions. Join us in revolutionizing the food industry across Africa.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-center">
                                ...
                                <a href="mailto:info@spex.africa" className="hover:text-[#71bc44] transition-colors duration-300">info@spex.africa</a>
                            </li>
                            <li className="flex items-center">
                                <Phone className="h-5 w-5 mr-3 text-[#71bc44]" />
                                <a href="tel:+1234567890" className="hover:text-[#71bc44] transition-colors duration-300">+123 456 7890</a>
                            </li>
