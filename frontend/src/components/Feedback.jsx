                    ...
                    <div className="flex flex-col items-start gap-5 bg-white rounded-lg shadow-lg py-20 px-5 lg:w-[80vw] lg:min-h-[95vh] overflow-y-auto">
                        ...
                        {modalDetails.map((detail, index) => (
                            <div key={index} className="w-full justify-start flex flex-col gap-5">
                                <h4 className="flex items-center justify-center gap-2 font-semibold font-nunito text-sm">
                                    <span>Question: </span>
                                    {detail.question}
                                </h4>
                                <p className="flex items-center justify-center gap-2 font-light font-nunito text-sm">
                                    <span>Answer: </span>
                                    {detail.answer}
                                </p>
                            </div>
