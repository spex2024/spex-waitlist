            ...
            <section className="w-full flex flex-col lg:flex-row justify-between h-[400px] lg:h-[300px] rounded-2xl bg-cover lg:px-20 gap-3 lg:mb-20 " >
                ...
                <div className={`lg:w-[80%]`}>
                    ...
                    <div className={`w-full lg:w-[60%] text-white lg:pe-10 space-y-4 mb-5 font-semi-bold`}>
                        ...
                        <p className={`text-lg font-nunito font-thin pe-10 `}> SPEX (Smartpack Exchange) is a meal marketplace, which leverages a web platform /app to connect food vendors to Enterprises/Users seeking sustainable food packaging.</p>
                    </div>
