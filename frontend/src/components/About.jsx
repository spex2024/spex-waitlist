...
function About(props) {
    ...
    return (
        <div id='about' className={`w-full h-auto  flex flex-col gap-10  mt-32 `}>
             <header className={`w-full px-5 h-[100px] flex flex-col  items-center justify-center  mb-20`}>
                 <h2 className={`text-3xl text-center lg:text-5xl font-bold font-serif px-5`}>Here's what sets us apart</h2>
                 -<p className={`font-sans px-5 text-center text-sm lg:text-md `} > -Reducing your packaging cost and waste while linking you to eco-centric users -</p>
             </header>
            <section className={`w-full   grid grid-cols-1 lg:grid-cols-2  gap-10`}>
                <div className={`w-full h-full  px-10 py-16`}>
                    <div
                        ...
                        <h2 className={`lg:text-md text-sm`}>The Problem</h2>
                    </div>
                ...
                <div className={`w-full h-full bg-green-700 p-10  bg-cover bg-center py-16 `}
                     style={{
                    ...
                    <div
                        ...
                        <h2 className={`lg:text-md text-sm`}>The Solution</h2>
                    </div>
