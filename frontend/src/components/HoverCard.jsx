...
import spexbg from "../assets/hero-1.jpg";
...
const HoverCard = () => {
    ...
    return (
        <section className="w-full flex justify-center items-center py-20 dark:bg-dark lg:py-5">
            <div ref={domNode} className="container">
                <div className="-mx-4 flex flex-wrap justify-center">
                    <div className="w-full px-4 lg:w-[80vw] lg:h-[95vh]">
                        <div className="relative  h-[300px] overflow-hidden rounded-lg md:h-full">
                            ...
                            >
                                <a
                                    ...
                                    className="absolute z-[1] flex h-20 w-20 items-center justify-center rounded-full bg-white text-primary dark:bg-dark-2 dark:text-white md:h-[100px] md:w-[100px]"
                                >
                                    <span className="absolute right-0 top-0  h-full w-full animate-ping rounded-full bg-white bg-opacity-20 delay-300 duration-1000"></span>
                                    <svg
                                        width="23"
                                        height="27"
                                        viewBox="0 0 23 27"
            ...
            {videoOpen && (
                <div className="fixed left-0 top-0 z-50 flex h-screen w-full items-center justify-center bg-black bg-opacity-70">
                    <div className="flex justify-center items-center  w-[900px] h-[900px]">
                        <div className="p-4">
