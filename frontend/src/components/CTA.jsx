...
function Cta(props) {
    return (
        <div id={"cta"} className="w-full flex flex-col lg:gap-5 items-center justify-around text-white min-h-[600px] py-10 lg:py-20 bg-[#1C2026]" >
            ...
            <div className="w-full max-w-lg h-[200px] flex flex-col justify-center items-center lg:mt-10 py-5 px-4">
                <p className="font-serif text-md sm:text-xl md:text-2xl text-center mb-5 font-nunito">
