...
function HomePrivate(props) {
    return (
        <>
            ...
            <header
                className='flex shadow-md py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[80px] tracking-wide relative z-50'>
                <div className='flex flex-wrap items-center gap-5 w-full'>
                    ...
                    <div id="collapseMenu"
                        ...
                        <ul
                            ...
                            <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                                                                                className='hover:text-[#007bff] text-[#333] font-semibold block text-[15px]'>Team</a>
                            </li>
                            <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                                                                                className='hover:text-[#007bff] text-[#333] font-semibold block text-[15px]'>Feature</a>
                            </li>
                    ...
                    <div className='flex items-center max-lg:ml-auto space-x-6'>
                        ...
                        <Link to={'/dashboard'}>
                            <button
                                className='px-4 py-2 text-[15px] rounded font-semibold text-[#007bff] border-2 border-[#007bff] hover:bg-[#007bff] transition-all ease-in-out duration-300 bg-transparent hover:text-white'> Dashboard
                            </button>
                        </Link>
